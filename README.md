...
class Solution:
    ...
    # https://leetcode.com/problems/minimum-area-rectangle/discuss/192278/python-solution-with-detailed-explanation(with-extra-Chinese-explanation)
```
We use an additional `s` to store points. This is better than only keep rows and cols. 
